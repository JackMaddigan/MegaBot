...
async function test() {
  const data = {
    ...
    "1209939284396744724": { score: 29, username: "IntergalacticPhillippooo" },
    "401500275799752704": { score: 3, username: "Sean_M" },
    "432960409788481547": { score: 9, username: "Cuberstache" },
    "474178859584061461": { score: 381, username: "DACHI" },
    ...
    "729534269369876531": { score: 20, username: "DosaEnjoyer" },
  ...
  const burgInfo = {
    lastTime: 1724876257426,
    lastUsername: "IntergalacticPhillippooo",
  };
  await saveData(
